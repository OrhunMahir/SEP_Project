#!/usr/bin/env python3
"""Collect image-size sweep summary metrics into one CSV table."""
...
DEFAULT_RUNS = (
    "runs/custom_cnn_image_160",
    "runs/custom_cnn_image_224",
    "runs/custom_cnn_image_288",
)
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        default="runs/image_size_sweep_summary.csv",
    ...
    print(f"Saved image-size comparison to: {output_path}")
