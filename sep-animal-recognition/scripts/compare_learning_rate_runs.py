#!/usr/bin/env python3
"""Collect learning-rate sweep summary metrics into one CSV table."""
...
DEFAULT_RUNS = (
    "runs/custom_cnn_lr_0005",
    "runs/custom_cnn_lr_001",
    "runs/custom_cnn_lr_002",
)
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        default="runs/learning_rate_sweep_summary.csv",
    ...
    print(f"Saved learning-rate comparison to: {output_path}")
