#!/usr/bin/env python3
"""Collect epoch-sweep summary metrics into one CSV table."""
...
DEFAULT_RUNS = (
    "runs/custom_cnn_epochs_10",
    "runs/custom_cnn_epochs_25",
    "runs/custom_cnn_epochs_50",
)
...
def main() -> None:
    ...
    parser.add_argument(
        "--output",
        default="runs/epoch_sweep_summary.csv",
